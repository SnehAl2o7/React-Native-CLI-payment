...
import {PaymentType, MainStackParamList} from '../types';

type PaymentFormScreenNavigationProp = NativeStackNavigationProp<
  MainStackParamList,
  'PaymentForm'
>;
type PaymentFormScreenRouteProp = RouteProp<MainStackParamList, 'PaymentForm'>;

interface Props {
  navigation: PaymentFormScreenNavigationProp;
  route: PaymentFormScreenRouteProp;
}
...
const getPaymentMeta = (
  ...
  switch (type) {
    case 'bank':
      return {title: 'Add Bank Account', icon: 'bank', iconColor: Colors.iconBank};
    case 'paytm':
      return {title: 'Add Paytm', icon: 'wallet', iconColor: Colors.iconPaytm};
    case 'upi':
      return {title: 'Add UPI', icon: 'cellphone-arrow-down', iconColor: Colors.iconUPI};
    case 'paypal':
      return {title: 'Add PayPal', icon: 'paypal', iconColor: Colors.iconPayPal};
    case 'usdt':
      return {title: 'Add USDT', icon: 'currency-usd', iconColor: Colors.iconUSDT};
  }
};
...
const PaymentFormScreen: React.FC<Props> = ({navigation, route}) => {
        ...
        <ScrollView
          ...
          <View style={styles.formCard}>
            <Text style={styles.formDescription}>
              Enter your {paymentType === 'bank' ? 'bank account' : paymentType} details
              below to save this payment method.
            </Text>
          ...
          <TouchableOpacity
            ...
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.submitButtonText}>Save Payment Method</Text>
              </>
            )}
          </TouchableOpacity>
        </ScrollView>
